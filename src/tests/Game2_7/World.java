...
public class World {
	...
	public World(){
		BLOCK_DIRT_TOP= new ImageIcon("src/tests/Game2_7/tile_topDirt1.png").getImage();
		BLOCK_DIRT= new ImageIcon("src/tests/Game2_7/tile_dirt1.png").getImage();
		BLOCK_STONE= new ImageIcon("src/tests/Game2_7/tile_stone.png").getImage();
		BLOCK_SKY= new ImageIcon("src/tests/Game2_7/tile_sky.png").getImage();
